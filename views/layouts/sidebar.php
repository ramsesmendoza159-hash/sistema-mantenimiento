...
// Ubicación: C:\xampp\htdocs\proyecto\views\layouts\sidebar.php
...
<nav class="col-md-2 d-md-block sidebar">
    <div class="brand">
        <h4><i class="fas fa-tools"></i> PROYECTO</h4>
    ...
    <ul class="nav flex-column">
        ...
        <?php if ($rol === 'admin'): ?>
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo $seccion === 'dashboard' ? 'active' : ''; ?>" href="/proyecto/admin/dashboard">
                    <i class="fas fa-chart-pie"></i> Dashboard
                </a>
            </li>
            
            <li class="nav-item">
                <a class="nav-link <?php echo $seccion === 'ordenes' ? 'active' : ''; ?>" href="/proyecto/admin/gestion_ordenes">
    ...
    <div class="user-info">
        ...
        <a href="/proyecto/auth/logout" class="btn btn-logout">
