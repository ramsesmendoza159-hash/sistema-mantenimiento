...
// Gestión de Supervisores - VERSIÓN CORREGIDA
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted small mb-0">
                <i class="fas fa-info-circle me-1"></i> Administra los supervisores del sistema
            </p>
        </div>
        <a href="/proyecto/supervisores/crear" class="btn btn-primary">
            <i class="fas fa-plus-circle me-1"></i> Nuevo Supervisor
        </a>
    </div>
        ...
        <div class="col-xl-4 col-lg-6 col-md-6">
            <div class="stat-card border-0">
                <div class="d-flex justify-content-between align-items-start">
                    <div>
                        <div class="stat-label text-muted text-uppercase small fw-semibold">Total Supervisores</div>
    ...
    <div class="card border-0">
        <div class="card-body">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div>
                                                <div class="fw-semibold"><?php echo htmlspecialchars($supervisor['nombre']); ?></div>
                                    ...
                                    <td>
                                        <span class="badge bg-info bg-opacity-10 text-info">
                                            <?php echo htmlspecialchars($supervisor['area'] ?? 'General'); ?>
                                        </span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-1">
                                            ...
                                            <form action="/proyecto/supervisores/eliminar/<?php echo $supervisor['id']; ?>" 
                                                  method="POST" class="d-inline" 
                                                  onsubmit="return confirm('¿Estás seguro de eliminar este supervisor?')">
            ...
            <div class="mt-3 text-muted small">
                <i class="fas fa-list me-1"></i> Mostrando <?= count($supervisores) ?> supervisor(es)
            </div>
        </div>
    </div>
