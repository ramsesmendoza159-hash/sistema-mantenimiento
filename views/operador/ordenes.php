...
// Mis Órdenes - Operador - VERSIÓN COMPLETA
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1 fw-bold">
                <i class="fas fa-clipboard-list text-primary me-2"></i>Mis Órdenes
            </h4>
            <p class="text-muted small mb-0">
                <i class="fas fa-info-circle me-1"></i> Órdenes de trabajo creadas por ti
            </p>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-1">
                                            <a href="/proyecto/ordenes/ver/<?php echo $orden['id']; ?>" class="btn btn-sm btn-info" title="Ver">
